...
set directory=/Users/huangzijie/codes/resources/vim-baks/.swp/
set undodir=/Users/huangzijie/codes/resources/vim-baks/.undo/
set backupdir=/Users/huangzijie/codes/resources/vim-baks/.backup
"-------------------------------------------------------------------------------------------  基本设置
let mapleader=" "
let mapleader="\<Space>"
...
inoremap < <><left>
inoremap ( <Esc>lxf<space>>i)
"  ((test)) 
map <LEADER>( diw<Esc>i(<Esc>p
imap <LEADER>( <Esc>diw<Esc>i(<Esc>p
